...
from .views import (
    ...
    chamados_manual_resolution_update,
...
urlpatterns = [
    ...
    path('planos-ativos/', PlanosAtivosView.as_view(), name='planos_ativos'),
    ...
    path('chamados/resolucao-manual/', chamados_manual_resolution_update, name='chamados_resolucao_manual'),
