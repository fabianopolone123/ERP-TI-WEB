...
VAULT_REVEAL_MAX_ATTEMPTS = int(os.environ.get('VAULT_REVEAL_MAX_ATTEMPTS', '5'))
VAULT_REVEAL_BLOCK_WINDOW_MINUTES = int(os.environ.get('VAULT_REVEAL_BLOCK_WINDOW_MINUTES', '10'))
